        ...
        function testCalistir() {
            ...
            if (tarihVal) {
                ...
                // O günün çekilişini geçmişten çıkarmalıyız ki motor "o günden öncesine" bakarak tahmin yapsın.
                // Eğer girilen tarih eşleşmediyse (gelecek bir tarih), en son bulduğumuz tarihi dahil ederiz.
                if (exactMatchFound) {
